...
def main():
    ...
    gcloud run deploy {SERVICE_NAME} \
        ...
        --max-instances=10 \
        --port=8080 \
        --set-env-vars=GCP_STORAGE_BUCKET={STORAGE_BUCKET},GOOGLE_CLOUD_PROJECT={PROJECT_ID},STORAGE_MODE=cloud,PORT=8080,API_PORT=8000,SCHEDULER_AUTH_TOKEN=REDACTED_SECRET
    """.replace('\n    ', ' \\\n    ')
